    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.testHafiz.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.testHafiz.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'testHafiz'){
                    geotab.addin.testHafiz.blur();
                } else {
                    geotab.addin.testHafiz.focus(global.api, global.state);
                }
            }
        }, 100);
    }
